<?php
    ...
    class DisclaimerGestionTable
    {
        ...
        //Fonction prend 2 parammètres (texte saisie et url de redirection)
        function insererDansTable(DisclaimerOptions $option)
        {
            ...
            try
            {
                ...
                $sql = $wpdb->prepare("UPDATE $table_disclaimer SET message_disclaimer = '%s', redirection_ko = '%s' WHERE id_disclaimer = %s", $option->getMessageDisclaimer(), $option->getRedirectionko(), 1);
