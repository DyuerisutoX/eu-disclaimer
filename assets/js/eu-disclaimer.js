...
$("#monModal").modal({
 ...
 $("#start").keyup(function(e){
    ...
    if (e.keyCode == "13")
    {
        ...
        if (age >= 18)
        {
            $("#monModal").html(`<p>Le vapobar, vous souhaite la bienvenue !</p><a href="" type="button" rel="modal:close" class="btn-green" id="actionDisclaimer">Oui</a>`);

        }

        else
        {
            $("#monModal").html("Vous n'avez pas l'âge requis, nous allons vous rediriger vers http://google.com");
